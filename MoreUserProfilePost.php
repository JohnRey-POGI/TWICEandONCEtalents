...
if (isset($_POST['UserPost'])){
    ...
    $ifprofile = $_POST['Profile'];
    //echo '<script>alert("'.$ifprofile.'")</script>';
    ...
    echo '
    <div id="postcontent" class="responsive" style="margin-top: 70px">
        <div style="font-size:30px">Profile</div><br><br>
        <form action="" method="POST">
            <div style="font-size:20px"><b style="margin-right:57px;">Name</b>
            <input id="uname" name="newuname" class="usernamepassinput" type="text" placeholder="'.$username.'" maxlength="10"></div>
            <br>
